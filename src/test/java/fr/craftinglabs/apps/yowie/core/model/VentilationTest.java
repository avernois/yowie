...
public class VentilationTest {
    ...
    should_have_an_id() {
        ...
        Ventilation ventilation = new Ventilation(id, 1200, "catégorie");
    ...
    should_have_a_catégorie() {
        Ventilation ventilation = new Ventilation(VentilationId.valueOf(1), 1200, "catégorie");
        
        assertEquals("catégorie", ventilation.catégorie());
    }
